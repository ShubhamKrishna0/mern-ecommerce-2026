// controllers/shop/cart-controller.js (ESM)
import Cart from "../../models/Cart.js"; // ✅ Add .js extension
...
export const updateCartItemQty = async (req, res) => {
  try {
    ...
    const index = cart.items.findIndex((item) => item.productId.toString() === productId);
    if (index === -1) return res.status(404).json({ success: false, message: "Cart item not present!" });
